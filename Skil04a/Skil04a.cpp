...
void FlightBooking::printStatus() {
	int perc = (double)reserved / capacity * 100; //bý til prósentuna
	cout << "Flight " << id << " : " << reserved << "/" << capacity << " (" << (perc) << "\%) seats reserved." << endl; //prenta út eins og í sýnidæminu í verkefnalýsingu.
}
